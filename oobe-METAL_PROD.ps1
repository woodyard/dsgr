...
$Global:oobeCloud = @{
    ...
    oobeRemoveAppxPackageName = 'CommunicationsApps','OfficeHub','People','Skype','Solitaire','Xbox','ZuneMusic','ZuneVideo','MicrosoftTeams','Windows.DevHome','YourPhone','Clipchamp','WindowsFeedbackHub','MicrosoftOfficeHub','Microsoft.Windows.Photos','OutlookForWindows','MixedReality','MSPaint','QuickAssist'
